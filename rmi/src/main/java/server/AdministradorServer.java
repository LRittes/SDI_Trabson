...
import shared.Administrador;
import shared.ClienteCallback;
import shared.Cozinha;
import shared.MercadoServidor;
import shared.Restaurante;
...
public class AdministradorServer extends UnicastRemoteObject implements Administrador {
    ...
    public void fazerComprasNoMercado(String nomeRestaurante, String[] produtos, ClienteCallback cliente) throws RemoteException {
        ...
        try {
            URL wsdlUrl = new URL("http://localhost:9000/mercado?wsdl");
            QName serviceQName = new QName("http://demo.example.com/", "MercadoServidorImplService");
